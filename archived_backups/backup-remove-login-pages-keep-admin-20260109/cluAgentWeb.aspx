<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="cluAgentWeb.aspx.cs" Inherits="_cluAgentWeb" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:salespipeline %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Customers] WHERE (([Agent] = @Agent) AND ([Web] = 1)) OR (([VPW] = 1)) ORDER BY [Created] DESC">
            <SelectParameters>
