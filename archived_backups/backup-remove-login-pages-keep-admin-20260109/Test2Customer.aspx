<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Test2Customer.aspx.cs" Inherits="tvp_Customer" %>
...
<tr>
     ...
     <td>
          <asp:DropDownList ID="txtbranch" runat="server" ToolTip="Select a branch of service if known">
...
<tr>
     ...
     <td>
          <asp:DropDownList ID="txthdischarge" runat="server" ToolTip="Select discharge status if known">
...
<tr>
     ...
     <td>
          <asp:DropDownList ID="txtapptset" runat="server" ToolTip="Select an appointment setter if applicable">
                <asp:ListItem>None</asp:ListItem>
