<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="custlookupagnt.aspx.cs" Inherits="_custlookupagnt" %>
...
<asp:Label runat="server" ID="Created" Visible="False"/>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) ORDER BY [Created] DESC">
    <SelectParameters>
