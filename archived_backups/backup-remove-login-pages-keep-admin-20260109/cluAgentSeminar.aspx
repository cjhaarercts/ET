<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="cluAgentSeminar.aspx.cs" Inherits="_cluAgentSeminar" %>
...
<head runat="server">
<title>Search for Seminar Leads by Agent</title>
     ...
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release"/>
         <div>
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" ToolTip="Select the agent for this view">
                ...
                <asp:ListItem>Maria Vilchez</asp:ListItem>
                <asp:ListItem>Web Lead</asp:ListItem>
                <asp:ListItem>Seminar Lead</asp:ListItem>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="EMail" HeaderText="EMail" SortExpression="EMail" Visible="False" NullDisplayText=' ' />
...
<tr>
     ...
     <td>
         ...
         <obout:Calendar ID="Calendar1" runat="server"
             ...
             DatePickerMode="true"
             TextBoxId="txtDate" ShowSecondSelector="False" TimeSelectorType="DropDownList" DatePickerImagePath="../images/icon2.gif" OffsetTop="1">
         </obout:Calendar>
     </td>
</tr>
<tr>
...
<tr>
     ...
     <td>
         <obout:OboutDropDownList ID="txtapptset" runat="server" ToolTip="Select an appointment setter if applicable" >     
                ...
                <asp:ListItem>Mary Beth Fleck</asp:ListItem>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE (([Agent] = @Agent) AND ([Seminar] = 1)) ORDER BY [Created] DESC">
    <SelectParameters>
        <asp:ControlParameter ControlID="DropDownList1" Name="Agent" PropertyName="SelectedValue" Type="String" />
        <asp:Parameter DefaultValue="Actvie" Name="Status" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
</form>
</body>
