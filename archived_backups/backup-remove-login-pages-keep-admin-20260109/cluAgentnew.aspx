<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="cluAgentnew.aspx.cs" Inherits="_cluAgentnew" %>
...
<head runat="server">
<title>Search for New Leads by Agent</title>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND [Status] = 'New' ORDER BY [CREATED] DESC">
    <SelectParameters>
