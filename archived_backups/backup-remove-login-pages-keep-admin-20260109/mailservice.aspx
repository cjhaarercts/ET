<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="mailservice.aspx.cs" Inherits="mailservice" %>
...
<title>Leads needing mail service</title>
<style type="text/css">
    .modalBackground
    {
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND [Status] = 'Mail - Info' ORDER BY [Created] DESC ">
    <SelectParameters>
