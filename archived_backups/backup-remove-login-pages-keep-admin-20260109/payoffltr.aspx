<%@ Page Language="C#" AutoEventWireup="true" CodeFile="payoffltr.aspx.cs" Inherits="payoffltr" %>
...
<title>Administrative Edit Page - Payoff Letters</title>
<style type="text/css">
    .modalBackground
    {
...
<asp:ToolkitScriptManager ID="ScriptManager1" runat="server" ScriptMode="Release"/>
    ...
    <br />
    <asp:Label ID="Label10" runat="server" Width="100px" />
        <br />
         Begin Date <asp:TextBox runat="server" ID="BeginDate" ToolTip="Using the popup calendar select a date and time for the appointment"/>
         <obout:Calendar ID="Calendar1" runat="server"
             Columns="1"
             DateFormat="yyyy-MM-dd"
             DatePickerMode="true"
             TextBoxId="BeginDate" ShowSecondSelector="False" TimeSelectorType="HtmlList" DatePickerImagePath="../images/icon2.gif" DateMin="01/01/2011" >
         </obout:Calendar>
        <br />
         <asp:Label ID="Label20" runat="server" Width="100px" />
         <br />
         End Date <asp:TextBox runat="server" ID="EndDate" ToolTip="Using the popup calendar select a date and time for the appointment"/>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="SoldDate" DataFormatString="{0:d}" HeaderText="Sold Date" SortExpression="SoldDate" NullDisplayText=' ' />
    </Columns>
</asp:GridView>
...
<asp:Label ID="lblresult" runat="server"/>
        ...
        <asp:Button ID="btnExportPDF" runat="server" Text="ExportToPDF" OnClick="btnExportPDF_Click" />
         &nbsp;
        <asp:Button ID="btnExportCSV" runat="server" Text="ExportToCSV" OnClick="btnExportCSV_Click" />
