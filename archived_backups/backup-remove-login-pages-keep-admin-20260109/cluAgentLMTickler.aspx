<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="cluAgentLMTickler.aspx.cs" Inherits="_cluAgentLMTickler" %>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="LDate" DataFormatString="{0:d}" HeaderText="Msg Left Date" SortExpression="LDate" NullDisplayText=' ' />
        ...
        <asp:BoundField DataField="EmailAddress" HeaderText="EMailAddress" SortExpression="EMail" NullDisplayText=' ' />
