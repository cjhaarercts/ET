<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="cluAgentSM.aspx.cs" Inherits="_cluAgentSM" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND [Status] = 'Sent Mail' ORDER BY [InfoSentDate] ASC, [Created] DESC ">
    <SelectParameters>
