<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="cluAgentSold.aspx.cs" Inherits="_cluAgentSold" %>
...
<head runat="server">
<title>Search for Sold Leads by Agent</title>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    DataSourceID="SqlDataSource1" OnRowCreaated="OnRowCreated">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND [Status] = 'Sold' ORDER BY [Created] DESC">
    <SelectParameters>
