...
<asp:Content ID="Content2" ContentPlaceHolderID="LoginContent2" Runat="Server">
    ...
    <asp:Panel runat="Server" ID="AnonymousMessagePanel">
           ...
           <!-- <p><asp:Button ID="lnkLogin" runat="server" Text="Log In" PostBackUrl="~/tvp/login.aspx" /></p>

       <!-- <asp:HyperLink runat="server" ID="tstlnkLogin" Text="Log In" NavigateUrl="~/tvp/Login.aspx"></asp:HyperLink> -->
    </asp:Panel>
