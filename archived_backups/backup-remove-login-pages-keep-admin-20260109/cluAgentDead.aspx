<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="cluAgentDead.aspx.cs" Inherits="_cluAgentDead" %>
...
<head runat="server">
<title>Search for Dead Leads by Agent</title>
...
<tr>
     ...
     <td>
          <obout:OboutDropDownList ID="txtapptset" runat="server" ToolTip="Select an appointment setter if applicable">
                ...
                <asp:ListItem>Michell McDonough</asp:ListItem>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND [Status] = 'Dead' ORDER BY [Created] DESC">
    <SelectParameters>
