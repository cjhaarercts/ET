...
public partial class custlookuplnhp   : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        if (txtDate.Text != "")
        {
            ...
            msg.Body = "You have an Appointment with " + txtfname.Text.ToString() + " " + txtlname.Text.ToString() + " " + txthphone.Text.ToString() + " " + txtmphone.Text.ToString() + " " + txtbranch.Text.ToString() + " " + txthdischarge.Text.ToString() + " " + txtages.Text.ToString() + " " + txtagent.Text.ToString();
            ...
            SmtpClient smtpclient = new SmtpClient("smtp.ashersolutions.com", 587);
            System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls12;
            //smtpclient.DeliveryMethod = SmtpDeliveryMethod.Network;
            //smtpclient.UseDefaultCredentials = false;
            //smtpclient.Credentials = new System.Net.NetworkCredential("info@ashersolutionsinc.com", "Fr3343v3r&^%", "");
            //smtpclient.Port = 465;
            //smtpclient.EnableSsl = true;
            try
            {
            SmtpClient client = new SmtpClient("smtp.ashersolutions.com", 587); // Renamed
            client.DeliveryMethod = SmtpDeliveryMethod.Network;
            client.UseDefaultCredentials = false;
            client.Credentials = new System.Net.NetworkCredential("info@ashersolutions.com", "Fr3343v3r&^%");
            client.Port = 587;
            client.EnableSsl = true;

            MailMessage tstmsg = new MailMessage();
            tstmsg.From = new MailAddress("info@ashersolutions.com");
            tstmsg.To.Add("recipient@example.com");
            tstmsg.Subject = "Test Email";
            tstmsg.Body = "This is a test email from ASP.NET";
