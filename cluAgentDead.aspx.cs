...
public partial class _cluAgentDead : Page
{
    ...
    private void UpdateCustomerRecord()
    {
        using (var cmd = new SqlCommand("UPDATE Customers SET FirstName=@FirstName, LastName=@LastName, Address=@Address, City=@City, State=@State, ZIP=@ZIP, HomePhone=@HomePhone, MobilePhone=@MobilePhone, EmailAddress=@EmailAddress, Branch=@Branch, HDischarge=@HDischarge, Ages=@Ages, Notes=@Notes, AppointmentSet=@AppointmentSet, Agent=@Agent, ApptSetter=@ApptSetter, Status=@Status WHERE Id=@Id", _connection))
        {
            ...
            {
                cmd.Parameters.AddWithValue("@CDate", SqlDateTime.Null);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            ...
            else if (txtstatus.Text == "Call Back")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Jan")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Feb")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Mar")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Apr")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - May")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Jun")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Jul")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Aug")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Sep")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Oct")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Nov")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Call Back - Dec")
            {
                cmd.Parameters.AddWithValue("@CDate", DateTime.Today);
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Sent Mail")
            {
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
                cmd.Parameters.AddWithValue("@CDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Mail - Info")
            {
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
                cmd.Parameters.AddWithValue("@CDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Mail - FUR")
            {
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
                cmd.Parameters.AddWithValue("@CDate", SqlDateTime.Null);
            }
            else if (txtstatus.Text == "Needs Phone Number")
            {
                cmd.Parameters.AddWithValue("@LDate", SqlDateTime.Null);
                cmd.Parameters.AddWithValue("@CDate", SqlDateTime.Null);
            }
