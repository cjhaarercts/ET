...
public partial class _cluAgentSeminar : Page
{
    ...
    private void UpdateCustomerRecord(DateTime? appointmentDate)
    {
                                         ...
                                         WHERE Id=@Id", con))
        {
            ...
            // Use typed parameter for appointment date to avoid AddWithValue inference issues
            ...
            // Default LDate/CDate as null, set below when needed
    ...
    private void SendAppointmentEmail(DateTime appointmentDate)
    {
        ...
        using (var msg = new MailMessage())
        {
            ...
            using (var attachment = new Attachment(stream, "appointment.ics", "text/calendar"))
            {
                ...
                // Use SmtpClient() so web.config <system.net><mailSettings> is honored
