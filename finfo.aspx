<%@ Page Language="C#" AutoEventWireup="true" CodeFile="finfo.aspx.cs" Inherits="finfo" %>
...
<title>FHome Administrative Edit Page</title>
<style type="text/css">
    .modalBackground
    {
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="EmailAddress" HeaderText="Email Address" SortExpression="EmailAddress" NullDisplayText=' ' />
    </Columns>
</asp:GridView>
...
<tr>
    ...
    <td><asp:TextBox ID="txtcompany" runat="server" ToolTip="Enter company name"/></td>
</tr>
<tr>
    <td align="right">
    First Name: 
...
<tr>
     ...
     <td>
         <asp:TextBox ID="txtemailadd" runat="server" ToolTip="Enter an email address"/>
     </td>
</tr>
<tr>
    <td align="right">
