...
public partial class finfo : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        txtlname.Text = gvrow.Cells[4].Text;
        txtfname.Text = gvrow.Cells[5].Text;
        txtemailadd.Text = gvrow.Cells[6].Text;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("update Funhomes set Company=@Company,FirstName=@FirstName,LastName=@LastName,EmailAddress=@EmailAddress", con);
        cmd.Parameters.AddWithValue("@Company", txtcompany.Text);
        cmd.Parameters.AddWithValue("@FirstName", txtfname.Text);
        cmd.Parameters.AddWithValue("@LastName", txtlname.Text);
        cmd.Parameters.AddWithValue("@Address", txtemailadd.Text);
    ...
    protected void btnExportCSV_Click(object sender, EventArgs e)
    {
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=Mailinfo.csv");
        Response.Charset = "";
