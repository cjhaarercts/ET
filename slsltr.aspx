<%@ Page Language="C#" AutoEventWireup="true" CodeFile="slsltr.aspx.cs" Inherits="dcards" %>
...
<asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" ToolTip="Select the agent for this view">
                ...
                <asp:ListItem>Ray Richardson</asp:ListItem>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND [Status] = 'Sold' AND [SoldDate] >= Convert(Date, SoldDate, 101)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList1" Name="Agent" PropertyName="Text" 
                Type="String" />
            <asp:ControlParameter ControlID="txtDate" Name="SoldDate" PropertyName="Text" 
                Type="String" />
        </SelectParameters>
    <DeleteParameters>
