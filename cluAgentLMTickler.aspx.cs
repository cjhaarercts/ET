...
public partial class _cluAgentLMTickler : Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        txtlname.Text = gvRow.Cells[7].Text;
        txtfname.Text = gvRow.Cells[8].Text;
        txtadd.Text = gvRow.Cells[9].Text;
        txtcity.Text = gvRow.Cells[10].Text;
        txtstate.Text = gvRow.Cells[11].Text;
        txtzip.Text = gvRow.Cells[12].Text;
        txthphone.Text = gvRow.Cells[13].Text;
        txtmphone.Text = gvRow.Cells[14].Text;
        txtemail.Text = gvRow.Cells[15].Text;
        txtbranch.Text = gvRow.Cells[16].Text;
        txthdischarge.Text = gvRow.Cells[17].Text;
        txtages.Text = gvRow.Cells[18].Text;
        txtnotes.Text = gvRow.Cells[19].Text;
        txtDate.Text = gvRow.Cells[20].Text.Trim() == "&nbsp;" ? "" : gvRow.Cells[20].Text;
        txtapptset.Text = gvRow.Cells[21].Text;
    ...
    private DateTime? ParseDate(string input)
    {
        ...
        // compatibility: explicit out variable instead of inline declaration
        DateTime parsed;
