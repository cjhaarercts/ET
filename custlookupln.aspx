<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="custlookupln.aspx.cs" Inherits="custlookupln" %>
...
<title>Search for Customer by Last Name</title>
<style type="text/css">
    .modalBackground
    {
...
<body>
    ...
    <h3>Search for Customer by Last Name</h3>
...
<form id="form1" runat="server">
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release"/>
         <div>
            ...
            <br />
            <br />
            <asp:TextBox ID="TextBox1" runat="server" ToolTip="Select the customer last name for this view" />
            <br />
            <br />
        ...
        <asp:TemplateField>
            <ItemTemplate>
                <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False"
                 CommandName="Edit" ImageUrl="~/Edit.jpg" Text="Edit" Width="25" Height="25" onclick="ImageButton1_Click" Visible="true" AlternateText="Edit" ToolTip="Click here to edit" />
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField>
            <ItemTemplate>        
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT DISTINCT * FROM [Customers] WHERE ([LastName] = @LastName)">
    <SelectParameters>
