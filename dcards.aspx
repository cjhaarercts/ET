<%@ Page Title="PLMS - CTS" Language="C#" AutoEventWireup="true" CodeFile="dcards.aspx.cs" Inherits="dcards" %>
...
<asp:Panel ID="pnlpopup" runat="server" BackColor="White" 
        Width="700px" style="display:none" ModalPopupBehaviorID="pnlpopup">
...
<tr>
    ...
    <td>     
    <asp:TextBox ID="txtfname" runat="server" ToolTip="Enter first name"/>
    </td>
</tr>
<tr>
    <td align="right">
...
<tr>
     ...
     <td>
          <asp:TextBox ID="txthphone" runat="server" ToolTip="Enter a vaild 10 digit phone # with dashes"/>
...
<tr>
     ...
     <td>
          <asp:TextBox ID="txtmphone" runat="server" ToolTip="Enter a valid 10 digit phone # with dashes" />
            <asp:RegularExpressionValidator
...
<tr>
     ...
     <td>
          <asp:TextBox ID="txtemail" runat="server" ToolTip="Enter a valid email address"/>
...
<tr>
     ...
     <asp:TextBox runat="server" ID="txtDate" ToolTip="Using the popup calendar select a date and time for the appointment"/>
         <obout:Calendar ID="Calendar1" runat="server"
             ...
             DatePickerMode="true"
             TextBoxId="txtDate" ShowSecondSelector="False" TimeSelectorType="HtmlList" DatePickerImagePath="../images/icon2.gif" DateMin="01/01/2011" ClientIDMode="Inherit">
         </obout:Calendar>
     </td>
</tr>
<tr>
     ...
     <td>
          <obout:OboutDropDownList ID="txtagent" runat="server" ToolTip="Select the agent for this record" >
                ...
                <asp:ListItem>Richard Stangler</asp:ListItem>
                <asp:ListItem>Mary Jo Hudson</asp:ListItem>
                <asp:ListItem>Cristina Tamayo</asp:ListItem>
                <asp:ListItem>Amy Wallace</asp:ListItem>
                <asp:ListItem>CTS</asp:ListItem>
                <asp:ListItem>Web Lead</asp:ListItem>
            </obout:OboutDropDownList>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND [Status] = 'Mail' OR [Status] = 'Mail - Info' ORDER BY [Created] DESC">
        <SelectParameters>
