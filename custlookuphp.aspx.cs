...
public partial class custlookuphp : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // emit the client id of dvContent into a small startup script so the client can reference it
        // RegisterStartupScript places this near the end of the form, safe for use by client code.
    ...
    {
        // classic switch for maximum compiler compatibility
        switch (agent)
        {
