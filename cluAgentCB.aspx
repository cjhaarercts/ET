...
<head runat="server">
    ...
    <script type="text/javascript">
        function Print() {
            // use client id emitted from code-behind to avoid inline code blocks
                    ...
                    <table width="100%" style="border:Solid 3px #D55500; width:100%; height:100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <obout:Calendar ID="Calendar1" runat="server" ShowTimeSelector="true" DateFormat="MM/dd/yyyy hh:mm" DatePickerMode="true" TextBoxId="txtDate" ShowSecondSelector="False" TimeSelectorType="DropDownList" DatePickerImagePath="icon2.gif" >
                                </obout:Calendar>
                            </td>
                        </tr>
                        <tr>
