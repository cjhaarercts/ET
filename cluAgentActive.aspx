<%@ Page Title="PLMS - Active Lead By Agent" Language="C#" AutoEventWireup="true" CodeFile="cluAgentActive.aspx.cs" Inherits="_cluAgentActive" %>
...
<head runat="server">
    <title>Search for Active Leads by Agent</title>
    ...
    <script type="text/javascript">
        function Print() {
            // use a data-binding expression like other pages to avoid inline code blocks
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
                ...
                <div id="dvContent" runat="server">
                    <table width="100%" style="border:Solid 3px #D55500; width:100%; height:100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <obout:OboutDropDownList runat="server" ID="txtstatus" MenuWidth="500" DataSourceID="sds1" DataTextField="Status" DataValueField="Status" AppendDataBoundItems="true" FolderStyle="styles/grand_gray/OboutDropDownList">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:salespipeline %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND [Status] = 'Active' ORDER BY [Created] DESC">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownList1" Name="Agent" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
