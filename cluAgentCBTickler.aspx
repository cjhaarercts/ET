<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="cluAgentCBTickler.aspx.cs" Inherits="_cluAgentCBTickler" %>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="CDate" DataFormatString="{0:d}" HeaderText="Called Date" SortExpression="CDate" NullDisplayText=' ' />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([Agent] = @Agent) AND ([Status] LIKE 'Call Back%') ORDER BY [CDate] DESC">
    <SelectParameters>
