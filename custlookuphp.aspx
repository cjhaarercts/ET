<%@ Page Title="PLMS - Customer lookup" Language="C#" AutoEventWireup="true" CodeFile="custlookuphp.aspx.cs" Inherits="custlookuphp" %>
...
<title>Customer Search by Phone</title>
<style type="text/css">
    .modalBackground
    {
...
<div>
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release"/>
         <div style="width: 275px; height: 66px">
          ...
          <br />
          <br />
          <asp:TextBox ID="TextBox1" runat="server" ToolTip="Select the phone number to look up" />
          <br />
          <br />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT * FROM [Customers] WHERE ([HomePhone] = @HomePhone)">
    <SelectParameters>
